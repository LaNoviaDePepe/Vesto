                    ...
                    <div className="relative group w-full">
                        ...
                        {type === "password" && (
                            <button
                                ...
                                className="absolute right-2 top-1/2 -translate-y-1/2 text-primary-700 dark:text-primary-400 hover:text-primary-600 justify-end hover:shadow-none transition-colors"
                            >
                                {showPassword ? (
