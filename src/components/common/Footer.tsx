        ...
        <footer className={`${bgColor} ${textColor} px-12 py-10 flex flex-col md:flex-row justify-between items-center md:items-start gap-8 font-[var(--font-body)] transition-colors duration-300`}>
            ...
            <div className="flex flex-col items-center md:items-end gap-5 md:ml-auto">
                ...
                <div className="flex items-center gap-6">
                    {/* ICONO APPLE (SVG) */}
                    {/* fill-current hereda el color del padre (blanco o negro) */}
                    <a href="https://apps.apple.com/es/" target="_blank" aria-label="Download on App Store" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* ICONO GOOGLE PLAY (SVG) */}
                    <a href="https://play.google.com/store/apps/" target="_blank" aria-label="Get it on Google Play" className="hover:opacity-80 transition-opacity">
