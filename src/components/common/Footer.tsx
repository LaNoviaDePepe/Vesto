                ...
                <ul className="flex flex-col items-center gap-1 text-inherit">
                    ...
                    <li>
                        <button
                            ...
                            className="hover:text-primary-400 dark:hover:text-primary-400 transition-colors text-sm font-medium h-auto py-1 leading-none hover:shadow-none hover:translate-y-0"
                        >
                            {t('footer.terms')}
                        </button>
                    </li>
                    ...
                    <li><button
                        ...
                        className="hover:text-primary-400 dark:hover:text-primary-400 transition-colors text-sm font-medium h-auto py-1 leading-none hover:shadow-none hover:translate-0">{t('footer.copyright_policy')}
                    </button></li>
                </ul>
            </div>
