    ...
    return (
        ...
        {/* --- SECCIÓN 2: INFO CARDS --- */}
            <section className="w-full py-20 px-32 flex flex-col items-center gap-16">
                ...
                <div className="w-full max-w-7xl bg-white rounded-4xl shadow-xl p-12 grid grid-cols-2 gap-16 items-center">
                ...
                <div className="w-full max-w-7xl bg-white rounded-4xl shadow-xl p-12 flex flex-col items-center gap-12">
